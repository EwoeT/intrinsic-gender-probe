...
#         print(pooled_output.dtype)
        ...
        stereotype_token_index = stereotype_token_index.reshape(len(pooled_output), 1, 100).float()
#         print(stereotype_token_index.dtype)
#         input = torch.randn(10, 3, 4)
#         mat2 = torch.randn(10, 4, 5)
        res = torch.bmm(stereotype_token_index, pooled_output).reshape(len(pooled_output),1024)
#         print(res)
#         hjhjdb
