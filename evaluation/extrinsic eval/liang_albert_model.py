...
def load_gender_pair_embeddings():
    with open('../../liang_sent_debias-master/debias-BERT/experiments/3_albert_large_saved_embs/num7993_a_pretrained.pkl', 'rb') as f:
        all_embeddings_a = pickle.load(f)

    with open('../../liang_sent_debias-master/debias-BERT/experiments/3_albert_large_saved_embs/num7993_b_pretrained.pkl', 'rb') as f:
...
gender_dir = get_gender_dir(1).to(device)
...
#       debias
        pooled_output = drop_bias(pooled_output, gender_dir)
